...
import { Zap, Sun, Battery, Clock, DollarSign, Leaf, Calculator, LayoutGrid, BarChart2, Activity, TrendingUp, AlertTriangle, RefreshCw, Download } from 'lucide-react';

const App = () => {
  // Navigation State
  const [activeTab, setActiveTab] = useState<'calculator' | 'planner' | 'graphs' | 'daily'>('calculator');
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-20">
      ...
      <header className="bg-slate-900 text-white pt-8 pb-24 px-4 md:px-8 shadow-lg relative overflow-hidden">
        ...
        {/* Tab Navigation */}
        <div className="max-w-7xl mx-auto mt-8 flex gap-2 relative z-10 overflow-x-auto pb-1 scrollbar-hide">
          <button
